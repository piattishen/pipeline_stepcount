...
def run_anaconda_script(textfile_path: str, env_name: str):
    # Run the commands directly without a batch script
    os.system(f"bash {textfile_path}")
...
# Usage: python mnt/c/Users/piatt/mHealthLab/stepcount_algorithm_repeat/pipeline_linux_stepcount.py DS_10_address_100.txt DS_10_test